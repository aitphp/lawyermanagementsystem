...
<body>
	...
	<div class="header-top">
		<div class="container">
			<div class="head-main">
				<h1><a href="<?php echo base_url('index.php/lawyer_controller/lawyer_home')?>"><img src="<?php echo base_url('Asset/User/images/law.png')?>" style="height: 90px;width:140px"></a></h1>
			</div>
			...
			<div class="navigation">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<!--  <li class="active"><a href="<?php echo base_url('index.php/Lawyer_controller/lawyer_home')?>">Home</a></li> -->

						<li><a href="<?php echo base_url('index.php/Lawyer_controller/client_request')?>">Client Request</a></li>

						<li><a href="<?php echo base_url('index.php/Lawyer_controller/Case_result_status')?>">Case Result Status</a></li>
						
						<li><a href="<?php echo base_url('index.php/lawyer_controller/my_profile')?>">My Profile</a></li>
						
						<li><a href="<?php echo base_url('index.php/lawyer_controller/logout')?>">Logout</a></li>
					</ul>
				</div>
				<!--/.navbar-collapse-->
			</nav>
