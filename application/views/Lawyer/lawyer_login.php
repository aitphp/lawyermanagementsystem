...
<center><h1 style="margin-top:30px;color: #803E2C;text-transform: uppercase;margin-left: 96px">Lawyer Login here</h1></center>

<div style="margin-left: 400px;width: 553px;margin-top: 50px;">
  <form style="text-transform: uppercase;" method="POST" name="form1" action="<?php echo base_url('index.php/Lawyer_controller/login_check')?>">
  ...
  <br>
    ...
    border-radius: 4px;box-sizing: border-box;" required="required" id="lname" name="lawyer_Email" placeholder="Enter your email..">
