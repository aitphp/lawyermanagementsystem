...
--
-- Host: 127.0.0.1
-- Generation Time: May 20, 2023 at 06:57 AM
...
(16, 'catherine', 'catherine@gmail.com', 'catherine'),
(17, 'admin', 'admin@gmail.com', 'admin'),
(18, 'admin', 'admin@gmail.com', 'admin'),
(19, 'admin', 'admin@gmail.com', 'admin');
...
(25, 'Rose de', '1682934827.jpg', '888', 'rose@gmail.com', '65', 'female', '30', '0', 6, '30', '4443332221', '11year', 34110),
...
(1, 'divya@gmail.com', 'aibel@gmail.com', 1, 'anu', '12321453421', '100', '12/24'),
(2, 'catherine@gmail.com', 'john@gmail.com', 2, 'sbi', '9988776655443322', '123', '12/24');
...
(1, 'aibel@gmail.com', '15', 'divya@gmail.com', 'family ', 'Approved', 'Payed', 'Win'),
(2, 'john@gmail.com', '2', 'catherine@gmail.com', 'hgfhg hvjhg', 'Approved', 'Payed', 'Win');
...
--
ALTER TABLE `admin`
  MODIFY `admin_id` int(56) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `payment`
  MODIFY `payment_id` int(56) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `register_case`
--
ALTER TABLE `register_case`
  MODIFY `register_id` int(56) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
